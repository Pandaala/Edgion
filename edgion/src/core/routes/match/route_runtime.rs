...
/// Trait for route runtime that can be used with RadixRouteMatchEngine
///
...
pub trait RouteRuntime: Send + Sync {
    ...
    /// Perform deep match validation (headers, methods, query params, etc.)
