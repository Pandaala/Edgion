...
| Annotation mechanism | [annotations-guide.md](./annotations-guide.md) | [00-annotations-overview.md](../../../skills/02-features/05-annotations/00-annotations-overview.md) | `docs/` explains placement and implementation boundaries; detailed key tables and reserved-key lists live in `skills/reference` |
