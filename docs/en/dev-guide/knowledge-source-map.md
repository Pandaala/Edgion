...
| Add a new resource type | [add-new-resource-guide.md](./add-new-resource-guide.md) | [00-add-new-resource.md](../../../skills/02-development/00-add-new-resource.md), [01-integration-testing.md](../../../skills/04-testing/01-integration-testing.md) | Keep executable workflow in `skills/`; keep broader background and examples in `docs/` |
...
| Requeue / cross-resource dependency resolution | No standalone doc entry yet | [06-requeue-mechanism.md](../../../skills/01-architecture/01-controller/06-requeue-mechanism.md), [skills/07-review/SKILL.md](../../../skills/07-review/SKILL.md) | This is agent-first knowledge and should primarily live in `skills/` |
...
- integration-test structure and debugging details live in [skills/04-testing/01-integration-testing.md](../../../skills/04-testing/01-integration-testing.md)
