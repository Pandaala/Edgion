# Plugin Composition and References

> **🔌 Edgion Extension**
> 
> The `ExtensionRef` referencing mechanism for EdgionPlugins is an Edgion extension feature that supports plugin composition and reuse.
...
- Keep reference chains shallow (3 levels or fewer recommended)
