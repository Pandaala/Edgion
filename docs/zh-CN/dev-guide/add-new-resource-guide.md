...
> 面向 AI / Agent 的主 workflow 入口现在是 [../../../skills/01-architecture/01-controller/09-add-new-resource/00-guide.md](../../../skills/01-architecture/01-controller/09-add-new-resource/00-guide.md)。
> 本文档保留给人看的背景说明和手工检查点。
