...
2. **定期轮转日志**: 使用 `logrotate` 或类似工具定期轮转 access.log
3. **集成日志系统**: 将 access.log 集成到 ELK、Loki 等日志分析平台
4. **监控关键指标**: 根据 access.log 设置告警，如高延迟、高错误率等

## 相关文档

- [插件配置指南](./README.md)
- [Preflight 策略配置](./preflight-policy-guide.md)
