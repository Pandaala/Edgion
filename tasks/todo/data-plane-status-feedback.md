...
| 5.2 | `skills/02-development/09-status-management.md` | Update to reflect data-plane feedback mechanism | Small |
...
- [09-status-management.md](../../skills/02-development/09-status-management.md) — Status management guidelines
