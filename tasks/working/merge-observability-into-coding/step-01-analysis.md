...
4. `skills/02-development/SKILL.md` — 引用 `03-coding-standards/SKILL.md` 和 `05-observability/00-access-log.md`
5. `skills/02-development/01-edgion-plugin-dev.md` — 引用 `05-observability/00-access-log.md`
6. `skills/02-development/08-conf-handler-guidelines.md` — 引用 `03-coding-standards/01-log-safety.md`
