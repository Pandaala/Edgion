...
> 编码规范见 `../coding-standards/SKILL.md`，插件相关开发优先参考本目录下的插件文档。
...
2. 参考 [observability/00-access-log.md](../observability/00-access-log.md) 了解 PluginLog 规范
3. 参考 [testing/00-integration-testing.md](../testing/00-integration-testing.md) 添加集成测试

### 添加新资源类型
1. 阅读 [00-add-new-resource.md](00-add-new-resource.md)
2. 参考 [architecture/08-resource-system.md](../architecture/08-resource-system.md) 理解资源系统
3. 参考 [architecture/01-config-center/SKILL.md](../architecture/01-config-center/SKILL.md) 理解处理流程
4. 如涉及依赖重排队，参考 [architecture/10-requeue-mechanism.md](../architecture/10-requeue-mechanism.md)

### 添加外部系统连接器
1. 阅读 [03-link-sys-dev.md](03-link-sys-dev.md)
2. 参考 [testing/02-link-sys-testing.md](../testing/02-link-sys-testing.md) 添加集成测试
...
3. 如涉及构建命令或 CI，再补看 [../cicd/SKILL.md](../cicd/SKILL.md)
