...
- [02-resource-controller.md](../architecture/01-config-center/02-kubernetes/02-resource-controller.md) — Status persistence and leader guard
- [08-resource-system.md](../architecture/08-resource-system.md) — Resource system and preparse
