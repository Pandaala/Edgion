...
> edgion-controller 是控制面，负责从 K8s API 或本地文件系统接收资源配置，
> 经过校验/预解析/处理后，通过 gRPC 同步给 Gateway 实例。
...
| [03-config-center/](03-config-center/SKILL.md) | 配置中心子系统 | 修改资源处理流程、K8s HA |
| [04-workqueue.md](04-workqueue.md) | Workqueue 与重试/退避机制 | 调试处理延迟、理解去重逻辑 |
| [05-resource-processor.md](05-resource-processor.md) | ResourceProcessor 流水线 | 修改资源处理逻辑、理解 Handler 接口 |
| [06-requeue-mechanism.md](06-requeue-mechanism.md) | 跨资源 Requeue 机制 | 排查依赖联动、理解 TriggerChain |
| [07-cache-server.md](07-cache-server.md) | ServerCache + EventStore | 调试 gRPC 同步数据源 |
| [08-acme-service.md](08-acme-service.md) | ACME 证书自动化服务 | 修改/调试自动证书 |
