...
| 2 Design | Define interfaces, data flow, config changes | `01-architecture/`, `02-development/SKILL.md` |
| 3 Implementation | Write code per design | `02-development/`, `03-coding/SKILL.md` |
| 4 Testing | Verify correctness | `04-testing/SKILL.md` |
| 5 Documentation | Update user/dev docs | `02-development/07-documentation-writing.md` |
| 6 Review | Retrospect, write back knowledge | `07-review/SKILL.md` |
...
| Review conclusions | `skills/07-review/` | Project-specific, reusable finding |
