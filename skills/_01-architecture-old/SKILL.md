---
name: architecture
description: Architecture navigation skill for Edgion. Use when a task needs system design context, internal module boundaries, the config center, gRPC sync, route matching, plugin execution, load balancing, or resource-system behavior before implementation.
---
...
| [10-requeue-mechanism.md](10-requeue-mechanism.md) | Requeue 机制与跨资源依赖 | 排查 resolved_ports、secret 依赖、post-init 时序问题 |
