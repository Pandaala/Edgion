...
- 保留现场后的排障步骤： [../06-tracing/00-debugging.md](../06-tracing/00-debugging.md)
...
详细命令和日志入口见 [../06-tracing/00-debugging.md](../06-tracing/00-debugging.md)。
...
- 要保留现场做手工排查： [../06-tracing/00-debugging.md](../06-tracing/00-debugging.md)
