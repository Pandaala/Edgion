...
description: Kubernetes config center skill for Edgion. Use when working on KubernetesCenter, leader election, HA behavior, ResourceController lifecycle, or status writeback paths in controller runtime.
---
