---
name: config-center
description: Config center skill for Edgion controller internals. Use when changing configuration loading, filesystem mode, Kubernetes mode, workqueue processing, ResourceProcessor behavior, or control-plane resource lifecycle.
---
