...
- [Add New Resource Guide](../01-development/00-add-new-resource.md) — step-by-step guide for adding new resource types
- [Config Center](01-config-center.md) — how resources are processed through Workqueue and ResourceProcessor
