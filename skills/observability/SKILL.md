---
name: observability
description: Observability skill for Edgion. Use when changing access logs, metrics, structured tracing, plugin logs, or log-safety rules in either control-plane or data-plane code.
---
