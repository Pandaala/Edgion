...
| `match_info.sv` | sync_version — gRPC 同步版本号，用于关联控制面日志（0 时省略）。详见 [coding-standards/00-logging-and-tracing-ids.md](../coding-standards/00-logging-and-tracing-ids.md) |
