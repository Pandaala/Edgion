...
pub use crate::core::conf_mgr::sync_runtime::resource_processor::{
    ProcessorHandler, ResourceProcessor, SecretRefManager,
};

// Re-export registry
pub use crate::core::conf_mgr::PROCESSOR_REGISTRY;

// Re-export metrics from local sync_runtime
pub use crate::core::conf_mgr::sync_runtime::metrics::{
