...
use crate::core::gateway::backends::discovery::endpoint::{get_endpoint_roundrobin_store, EndpointExt};
use crate::core::gateway::backends::discovery::endpoint_slice::{get_roundrobin_store, EndpointSliceExt};
