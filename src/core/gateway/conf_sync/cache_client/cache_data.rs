use crate::core::common::conf_sync::traits::{ConfHandler, ResourceChange};
...
impl CompressEvent {
    ...
    pub fn add_event(&mut self, key: String, change: crate::core::common::conf_sync::traits::ResourceChange) {
