...
impl ConfigClient {
    ...
    pub fn new(client_id: String, client_name: String) -> Self {
        ...
        let plugin_handler = crate::core::gateway::plugins::http::create_plugin_handler();
        ...
        let tcp_route_handler = crate::core::gateway::routes::tcp::create_tcp_route_handler();
        ...
        let udp_route_handler = crate::core::gateway::routes::udp::create_udp_route_handler();
        ...
        let grpc_route_handler = crate::core::gateway::routes::grpc::create_grpc_route_handler();
        ...
        let tls_route_handler = crate::core::gateway::routes::tls::create_tls_route_handler();
        ...
        let tls_handler = crate::core::gateway::tls::create_tls_handler();
        ...
        let stream_plugin_handler = crate::core::gateway::plugins::stream::create_stream_plugin_handler();
        ...
        let backend_tls_policy_handler = crate::core::gateway::backends::create_backend_tls_policy_handler();
        ...
        let gateway_class_handler = crate::core::gateway::config::gateway_class::create_gateway_class_handler();
        ...
        let gateway_handler = crate::core::gateway::runtime::create_gateway_handler();
        ...
        let edgion_gateway_config_handler =
            crate::core::gateway::config::edgion_gateway::create_edgion_gateway_config_handler();
        ...
        let acme_handler = crate::core::gateway::services::acme::create_acme_handler();
        ...
        Self {
            ...
            link_sys: {
                ...
                let link_sys_handler = crate::core::gateway::link_sys::create_link_sys_handler();
    ...
    pub async fn set_all_grpc_clients(
        &self,
        client: crate::core::common::conf_sync::proto::config_sync_client::ConfigSyncClient<tonic::transport::Channel>,
    ) {
