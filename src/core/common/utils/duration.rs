...
/// ```
/// use std::time::Duration;
/// use edgion::core::common::utils::parse_duration;
///
...
mod tests {
    ...
    fn test_parse_empty_string() {
        assert_eq!(parse_duration(""), Err(ParseDurationError::EmptyString));
        assert_eq!(parse_duration("   "), Err(ParseDurationError::EmptyString));
    }
    ...
    fn test_parse_negative_duration() {
        assert_eq!(parse_duration("-30s"), Err(ParseDurationError::NegativeDuration));
        assert_eq!(parse_duration("-5m"), Err(ParseDurationError::NegativeDuration));
    }

    #[test]
    fn test_parse_unknown_unit() {
        assert!(matches!(parse_duration("30y"), Err(ParseDurationError::UnknownUnit(_))));
        assert!(matches!(parse_duration("5d"), Err(ParseDurationError::UnknownUnit(_))));
    }
