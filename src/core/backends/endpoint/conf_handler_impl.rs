...
use super::{get_endpoint_roundrobin_store, get_endpoint_consistent_store, get_endpoint_leastconn_store, get_endpoint_ewma_store};
use super::discovery_impl::{EndpointLoadBalancer, EndpointExt};
...
impl ConfHandler<Endpoints> for EndpointHandler {
    ...
    fn partial_update(&self, add: HashMap<String, Endpoints>, update: HashMap<String, Endpoints>, remove: HashSet<String>) {
